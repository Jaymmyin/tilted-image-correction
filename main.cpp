...
int main()
{
	using namespace dec;
        ...
        //std::cout << "Value #1 is: " << value << endl;
        ...
        //std::cout << "Value #2 is: " << value << endl;

        // automatic rounding performed here
        value /= 1000;

        // displays: Value #3 is: 143.13
        //std::cout << "Value #3 is: " << value << endl;
        ...
        //std::cout << "Value: " << value << " * 2 is: " << (value * 2) << endl;

        // to use integer on left side you need to cast it
        // displays: Value: 2 * 143.13 is: 286.26
        //std::cout << "Value: 2 * " << value << " is: " << (decimal_cast<2>(2) * value) << endl;
        ...
        //std::cout << "Value #4 is: " << value << endl;
        ...
        //std::cout << "Value #5 is: " << value << endl;
        ...
        //std::cout << "Value #5 calculated with double is: " << fixed << setprecision(2) << dvalue << endl;
        ...
        //std::cout << "mixed d2 = " << d2 << endl;
        // for default setup displays: mixed d4 = 687.2303
        //std::cout << "mixed d4 = " << d4 << endl;
}